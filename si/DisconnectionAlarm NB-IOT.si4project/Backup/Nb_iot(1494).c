...
void NB73Tsak(void)
{
	...
	switch(NbiotDev.step)
	{
		...
		case NB_NOR_COMM:
			...
			break;
		case NB_AT_NSOSD:
			{  //{"SN":"451315531222","ALARM_TYPE":"DISCONNECT_WIRE"}
				...
				if(NbiotDev.cmdTxStep == 0)
				{
					...
					sprintf(stbuff,"{\"SN\":\"%15s\",\"ALARM_TYPE\":\"%s\"}\0",NbiotDev.sN,alarm_str[NbiotDev.alarmTpye]);
...
void SetSendAlarmDataToCloud(alarm_tpye alarm_type)
{
	...
	NbiotDev.cmdTxStep = 0;
	NbiotDev.cmdErrCnt = 0;
	NbiotDev.alarmTpye = DISCONNECT_WIRE;
}
